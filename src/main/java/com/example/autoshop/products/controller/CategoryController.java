...
public class CategoryController {
    ...
    public ResponseEntity<CategoryDTO> createCategory(InputCategoryDto dto){
    ...
    public ResponseEntity<CategoryDTO> updateCategory(@PathVariable("id") Long id, InputCategoryDto dto){
